const Contact = () => (
  <div className="m-3">
    <div>
      ...
      <p className="pb-5">We value your feedback and are here to assist you in any way possible. Feel free to reach out to us through the following channels:</p>
      ...
      <p>
        ...
        We are committed to enhancing your Mr.Foody experience and are eager to hear from you. Your input helps us grow and serve you better.</p>
        <br /><br />
        Thank you for choosing Mr.Foody as your culinary companion!
    </div>
  </div>
)
